                ...
                <div className="pokemon-expanded-header">
                    <div className="pokemon-expanded-header-left">
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '4px', marginTop: '6px', opacity: 0.9 }}>
                                <button
                    ...
                    >
                        ...
                        {badge != null && (
                            <span style={{
                                ...
                                background: id === 'stats' || id === 'evolution' ? 'var(--color-success-text)' : 'var(--text-muted)',
            ...
            <div style={{ padding: '15px', overflowY: 'auto', maxHeight: 'calc(100vh - 240px)' }}>
                {editTab === 'info' && (
                    <div>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '15px' }}>
                            ...
                            <div>
                                ...
                                {pokemon.origin === 'hatched' && (
                                    <div style={{ marginTop: '3px', fontSize: '12px', color: 'var(--text-muted)' }}>Sets minimum Loyalty to 2</div>
                                )}
                            </div>
                        </div>

                        {/* Section: Loyalty */}
                        <div style={{ fontSize: '12px', fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.6px', marginBottom: '8px', paddingTop: '10px', borderTop: '1px solid var(--border-light)' }}>Loyalty</div>
                        {(() => {
                        ...
                        <div style={{ fontSize: '12px', fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.6px', marginBottom: '8px', paddingTop: '10px', borderTop: '1px solid var(--border-light)' }}>
                            ...
                            {derivedAbilities.length > 0 ? (
                                <div className="abilities-available-box" style={{ padding: '10px', borderRadius: '8px' }}>
                                    <div style={{ marginBottom: '8px' }}>
                                        ...
                                        <div className="text-muted" style={{ fontSize: '11px', marginTop: '2px' }}>● Basic · ★ Adv. · ◆ High</div>
                                    </div>
                        ...
                        <div style={{ fontSize: '12px', fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.6px', marginBottom: '10px', paddingTop: '10px', borderTop: '1px solid var(--border-light)' }}>Held Item &amp; Appearance</div>
                        ...
                        <div style={{ marginBottom: '15px' }}>
                            ...
                            <div style={{ position: 'relative' }}>
                                <div style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
                                    ...
                                    <input
                                        type="text"
                                        placeholder={pokemon.heldItem ? `Current: ${pokemon.heldItem} — search to change…` : 'Search inventory or type custom name...'}
                        ...
                        <div style={{ marginBottom: '15px' }}>
                            <label style={{ fontSize: '13px', fontWeight: 'bold', marginBottom: '8px', display: 'block' }}>
                                Custom Image <span style={{ fontWeight: 'normal', fontSize: '12px', color: 'var(--text-muted)' }}>(optional)</span>
                            </label>
                        ...
                        {/* Danger zone */}
                        <div style={{ paddingTop: '10px', borderTop: '1px solid var(--border-light)', marginTop: '4px' }}>
                            <div style={{ fontSize: '12px', fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.6px', marginBottom: '8px' }}>Danger Zone</div>
                            <button
                                onClick={() => {
                                    showConfirm({
                ...
                {editTab === 'stats' && (
                    <div>
                                ...
                                <div style={{ marginBottom: '10px', display: 'flex', alignItems: 'center', gap: '6px', flexWrap: 'wrap', padding: '6px 10px', borderRadius: '6px', background: 'var(--tint-purple-bg)', border: '1px solid var(--tint-purple-border)' }}>
                                    ...
                                    {nd?.buff && nd?.nerf ? (
                                        <>
                                            ...
                                            <span style={{ fontSize: '12px', fontWeight: 'bold', color: 'var(--color-success-text)' }}>+2 {nd.buff.toUpperCase()}</span>
                                            <span style={{ fontSize: '12px', color: 'var(--text-muted)' }}>/</span>
                                            <span style={{ fontSize: '12px', fontWeight: 'bold', color: 'var(--color-danger-text)' }}>−2 {nd.nerf.toUpperCase()}</span>
                                            <span style={{ fontSize: '12px', color: 'var(--text-muted)', marginLeft: '2px' }}>(HP modifier is ±1)</span>
                                        </>
                                    ) : (
                                        <span style={{ fontSize: '12px', color: 'var(--text-muted)' }}>· no stat changes</span>
                                    )}
                                </div>
                            );
                        })()}
                        ...
                        <div className="stat-cards-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px' }}>
                            {(() => {
                                ...
                                <div key={stat} className="bg-light" style={{ padding: '10px', borderRadius: '8px', textAlign: 'center', boxShadow: canAdd ? `0 0 0 2px ${statColor}` : '0 1px 3px rgba(0,0,0,0.06)', borderTop: `3px solid ${statColor}`, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                                    ...
                                    <div className="text-light" style={{ fontSize: '12px', marginBottom: '1px', color: 'var(--text-muted)' }}>
                                        {natureModifiedBase[stat] || 10}
                                    </div>
                                    {/* P11: show greyed "0" instead of em-dash when nothing added */}
                                    <div style={{ fontSize: '12px', fontWeight: 'bold', color: addedVal > 0 ? statColor : 'var(--text-muted)' }} title="Points you've added from level-up bonuses.">
                                        {addedVal > 0 ? `+${addedVal}` : <span style={{ fontSize: '11px', opacity: 0.35 }}>+0</span>}
                                    </div>
                                    <div style={{ borderTop: '1px solid var(--border-light)', margin: '3px 0 3px', paddingTop: '3px', fontSize: '20px', fontWeight: 'bold' }} title="Nature-modified base stat ± added points. Used for damage calculations and skill checks.">
                                        {actualStats[stat]}
                                    </div>
                                    </div>
                                    ...
                                    {(addViolates || removeViolates) && (
                                        <div style={{ fontSize: '12px', color: 'var(--color-danger-text)', marginTop: '3px', lineHeight: 1.3, textAlign: 'center', opacity: 0.85 }}>
                                            ⚠ Rule blocked
                                        </div>
                                    )}
                                </div>
                        ...
                        <div style={{ marginTop: '8px', padding: '6px 10px', borderRadius: '6px', background: 'var(--tint-purple-bg)', border: '1px solid var(--tint-purple-border)', fontSize: '12px', color: 'var(--text-muted)', lineHeight: 1.5 }}>
                        ...
                        <div style={{ marginTop: '15px', padding: '12px 14px', background: 'var(--bg-light)', borderRadius: '8px', border: '1px solid var(--border-light)', borderTop: '3px solid var(--color-purple)' }}>
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px', textAlign: 'center' }}>
                                ...
                                <div title="Current HP after damage. When reduced to 0, the Pokémon faints.">
                                    ...
                                    <div style={{ fontSize: '12px', color: 'var(--text-muted)', marginTop: '2px' }}>set in Battle tab</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                {editTab === 'moves' && (
                    <div>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '10px' }}>
                            <span style={{ fontSize: '12px', fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.6px' }}>Known Moves</span>
                            <span className="text-muted" style={{ fontSize: '12px' }}>{(pokemon.moves || []).length}/{MAX_TOTAL_MOVES}</span>
                            <button
                        ...
                        {((pokemon.moves || []).length < MAX_TOTAL_MOVES || naturalMoveCount > 0 || taughtMoveCount > 0) && (
                            <div style={{ marginTop: '14px', background: 'var(--bg-light)', border: '1px solid var(--border-light)', borderRadius: '8px', padding: '10px 12px' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                                <span style={{ fontSize: '12px', fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.6px' }}>Add Moves</span>
                                <button
                            ...
                            <div className="add-move-panel" style={{ padding: '12px', borderRadius: '8px' }}>
                                ...
                                {/* Search Input — top for immediate access */}
                                ...
                                {(pokemon.moves?.length || 0) >= MAX_TOTAL_MOVES && (
                                    <div style={{ padding: '6px 10px', background: 'var(--warning-bg)', border: '1px solid var(--warning-border)', borderRadius: '4px', fontSize: '12px', color: 'var(--warning-text)', marginBottom: '8px' }}>
                    ...
                    <div>
                        <div style={{ marginBottom: '10px' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '3px' }}>
                                <span style={{ fontSize: '13px', fontWeight: 'bold', color: 'var(--text-primary)' }}>Pokémon Skills</span>
                                <button
                            ...
                            <div style={{ fontSize: '12px', color: 'var(--text-muted)' }}>Read-only — set by species. Click any skill for details.</div>
                        </div>
                                ...
                                {(pokemon.pokemonSkills || []).map((skill, idx) => (
                                    <div
                                        ...
                                        style={{
                                            ...
                                            cursor: showDetail ? 'pointer' : 'default',
                                            opacity: (skill.value === undefined || skill.value === 0) ? 0.45 : 1,
                                            transition: 'background 0.2s ease'
                                        }}
                                    >
                                        <div>
                                            <div style={{ fontWeight: 'bold', fontSize: '13px' }}>{skill.name}</div>
                                            {(() => {
                                                let skillData = GAME_DATA?.pokemonSkills?.[skill.name];
                                                if (!skillData && GAME_DATA?.pokemonSkills) {
                                                    ...
                                                    if (k) skillData = GAME_DATA.pokemonSkills[k];
                                                }
                                                ...
                                                return (
                                                    <div style={{ fontSize: '12px', color: 'var(--text-muted)', marginTop: '2px' }}>
                                                        ...
                                                        {desc.length > 80 && showDetail && (
                                                            <span style={{ color: 'var(--color-purple)', marginLeft: '4px', fontSize: '12px' }}>click for full</span>
                                                        )}
                                                    </div>
                                                );
                                            })()}
                                        ...
                                        {(() => {
                                            ...
                                            return (
                                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1px', flexShrink: 0 }}>
                                                    <div style={{
                                                        padding: '3px 10px',
                                                        background: hasValue ? 'var(--skill-value-color)' : 'var(--border-light)',
                ...
                {editTab === 'evolution' && (
                    <div>
                        {getEvolutionOptions && (() => {
                            ...
                            const renderSpeciesCard = ({ species, regionalForm, label, types, baseStats, variant = 'neutral', showNature = true }) => {
                                ...
                                return (
                                    <div style={{ flex: '1 1 100px', minWidth: '90px', textAlign: 'center', padding: '10px 6px', borderRadius: '8px', background: styles.bg, border: `1px solid ${styles.border}` }}>
                                        {label && (
                                            <div style={{ fontSize: '12px', fontWeight: 'bold', color: styles.label, marginBottom: '6px' }}>
                                        ...
                                        {/* Nature badge — only shown on current form card */}
                                        {showNature && pokemon.nature && (
                                ...
                                <>
                                    {canEvolve && canEvolve.length > 0 && (
                                        <div style={{ marginBottom: '16px' }}>
                                            <div style={{ fontSize: '12px', fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.6px', marginBottom: '10px' }}>Evolution Options</div>
                                                ...
                                                return (
                                                    <div key={idx} style={{ marginBottom: '10px', padding: '12px', borderRadius: '10px', border: '1px solid var(--border-light)', background: 'var(--surface-bg)' }}>
                                                        ...
                                                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '10px', flexWrap: 'wrap' }}>
                                                            ...
                                                            <div style={{ flexShrink: 0, width: 36, textAlign: 'center', alignSelf: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '2px' }}>
                                                <span style={{ fontSize: '28px', fontWeight: 'bold', color: evo.canEvolveNow ? 'var(--stat-hp)' : 'var(--border-medium)', lineHeight: 1 }}>→</span>
                                                <span style={{ fontSize: '10px', fontWeight: 'bold', color: evo.canEvolveNow ? 'var(--stat-hp)' : 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.3px' }}>{evo.canEvolveNow ? 'evolves' : 'locked'}</span>
                                            </div>
                                                            {renderSpeciesCard({
                                                        ...
                                                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '8px' }}>
                                                            {evo.canEvolveNow ? (
                                                                ...
                                                                <div style={{ fontSize: '12px', color: 'var(--poke-orange)', fontWeight: 600, padding: '4px 8px', borderRadius: '4px', background: 'var(--tint-orange-bg)', border: '1px solid var(--tint-orange-border)' }}>
                                                                    🔒 {evo.reason || evo.requirement}
                                                                    {evo.note && ` (${evo.note})`}
                                                                </div>
                                                            )}
                                    ...
                                    {canDevolve && devolvePokemon && (
                                        <div>
                                            ...
                                            <div style={{ fontSize: '12px', fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.6px', marginBottom: '10px' }}>Devolution</div>
                                            <div style={{ padding: '12px', borderRadius: '10px', border: '1px solid var(--border-light)', background: 'var(--surface-bg)' }}>
                                                ...
                                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '10px' }}>
                                                    ...
                                                    <div style={{ flexShrink: 0, width: 36, textAlign: 'center', alignSelf: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '2px' }}>
                                        <span style={{ fontSize: '28px', fontWeight: 'bold', color: 'var(--color-danger-text)', lineHeight: 1 }}>←</span>
                                        <span style={{ fontSize: '10px', fontWeight: 'bold', color: 'var(--color-danger-text)', textTransform: 'uppercase', letterSpacing: '0.3px' }}>reverts</span>
                                    </div>
                                                    {(() => {
