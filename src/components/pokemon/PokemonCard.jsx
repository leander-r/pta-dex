                                ...
                                return abilities.length > 0 && (
                                    <button
                                        ...
                                        style={{
                                            padding: '4px 10px',
                                            borderRadius: '12px',
                                            border: expandedSection === 'abilities' ? '1.5px solid transparent' : '1.5px solid var(--border-medium)',
                                            background: expandedSection === 'abilities' ? 'var(--gradient-purple)' : 'var(--collapsed-btn-bg)',
                                ...
                                return (
                                    <button
                                        ...
                                        style={{
                                            padding: '4px 10px',
                                            borderRadius: '12px',
                                            border: expandedSection === 'moves' ? '1.5px solid transparent' : '1.5px solid var(--border-medium)',
                                            background: expandedSection === 'moves' ? 'var(--gradient-purple)' : 'var(--collapsed-btn-bg)',
                            ...
                            {(pokemon.pokemonSkills || []).filter(s => s.value === undefined || s.value > 0).length > 0 && (
                                <button
                                    ...
                                    style={{
                                        padding: '4px 10px',
                                        borderRadius: '12px',
                                        border: expandedSection === 'skills' ? '1.5px solid transparent' : '1.5px solid var(--border-medium)',
                                        background: expandedSection === 'skills' ? 'var(--gradient-purple)' : 'var(--collapsed-btn-bg)',
                    ...
                    <div>
                            ...
                            <div style={{ position: 'relative' }}>
                                ...
                                <div style={{ position: 'relative' }}>
                                    <input
                                        ...
                                        placeholder={pokemon.species ? `Current: ${pokemon.species} — search to change…` : 'Search species by name...'}
                                        style={{
                                            width: '100%',
                                            padding: '10px',
                            ...
                            <div>
                                ...
                                <div style={{ display: 'flex', gap: '4px' }}>
                                    <input
                                        ...
                                        min="0"
                                        style={{ flex: 1, padding: '10px', borderRadius: '6px', border: '1px solid var(--border-medium)', background: 'var(--input-bg)', color: 'var(--text-primary)' }}
                                    />
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '15px' }}>
                            ...
                            <div>
                                ...
                                {pokemon.origin === 'hatched' && (
                                    <div style={{ marginTop: '3px', fontSize: '11px', color: 'var(--text-muted)' }}>Sets minimum Loyalty to 2</div>
                                )}
                            </div>
                        </div>
                        ...
                        >
                            ...
                            {!showContestSection && (() => {
                                ...
                                if (!anyContest && !anyRibbons) return <span style={{ fontSize: '11px', color: 'var(--text-muted)', fontWeight: 'normal' }}>(none)</span>;
                                const totalRibbons = Object.values(ribbons).reduce((s, v) => s + (v || 0), 0);
                                return <span style={{ fontSize: '11px', color: 'var(--text-muted)', fontWeight: 'normal' }}>{totalRibbons > 0 ? `${totalRibbons} ribbon${totalRibbons !== 1 ? 's' : ''}` : 'stats set'}</span>;
                            })()}
                        </button>
                        {showContestSection && (() => {
                        ...
                        <div style={{ marginBottom: '15px' }}>
                            ...
                            <div style={{ position: 'relative' }}>
                                <div style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
                                    ...
                                    />
                                    <span style={{ position: 'absolute', right: '10px', top: '50%', transform: `translateY(-50%) ${showHeldItemDropdown ? 'rotate(180deg)' : ''}`, color: 'var(--text-muted)', pointerEvents: 'none', fontSize: '10px', transition: 'transform 0.2s ease' }}>▼</span>
                                    </div>
                                    {pokemon.heldItem && (
                                        <button
                        ...
                        <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center' }}>
                            ...
                            <button
                                ...
                                className="pokemon-action-btn export"
                                style={{ background: 'var(--stat-satk)' }}
                            ...
                            {(() => {
                                ...
                                <div key={stat} className="bg-light" style={{ padding: '10px', borderRadius: '8px', textAlign: 'center', boxShadow: canAdd ? `0 0 0 2px ${statColor}` : '0 1px 3px rgba(0,0,0,0.06)', borderTop: `3px solid ${statColor}`, minHeight: '120px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                                    ...
                                    <div style={{ fontSize: '12px', fontWeight: 'bold', color: addedVal > 0 ? statColor : 'var(--text-muted)' }} title="Points you've added from level-up bonuses.">
                                        {addedVal > 0 ? `+${addedVal}` : <span style={{ fontSize: '10px', opacity: 0.4 }}>+0</span>}
                                    </div>
                            ...
                            <div className="add-move-panel" style={{ padding: '12px', borderRadius: '8px' }}>
                                ...
                                {(() => {
                                    ...
                                    if (sources.length <= 1) return (
                                        <div style={{ fontSize: '11px', color: 'var(--text-muted)', marginBottom: '8px', padding: '5px 8px', background: 'var(--bg-light)', borderRadius: '5px', border: '1px dashed var(--border-medium)' }}>
                                ...
                                return (
                                    <div style={{ flex: '1 1 100px', minWidth: '90px', textAlign: 'center', padding: '10px 6px', borderRadius: '8px', background: styles.bg, border: `1px solid ${styles.border}` }}>
                                        ...
                                        {displayStats && (
                                            ...
                                            <div style={{ gridColumn: '1 / -1', fontSize: '10px', color: 'var(--text-muted)', textAlign: 'center', marginBottom: '2px', opacity: 0.7 }}>{pokemon.nature ? 'nature-modified' : 'base stats'}</div>
                                                {STAT_ORDER.map(s => {
